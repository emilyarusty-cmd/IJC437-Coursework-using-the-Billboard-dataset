...
indexhtml <- paste0(
  "<!doctype html>",
  "<html><head><meta charset='utf-8'><title>IJC437 Billboard Success</title>",
  "<style>body{font-family:Arial, sans-serif; max-width:900px; margin:40px auto; line-height:1.5;} ",
  "img{max-width:100%; height:auto; border:1px solid #ddd; padding:6px; margin:10px 0;} ",
  "code{background:#f4f4f4; padding:2px 5px;}</style>",
  "</head><body>",
  "<h1>IJC437 Coursework – Billboard Chart Success (2000–2023)</h1>",
  "<p>This project investigates whether Spotify audio features are associated with chart success in the Billboard Hot 100 between 2000 and 2023.</p>",
  "<h2>Research questions</h2>",
  "<ol>",
  "<li>Which Spotify audio features are most strongly associated with peak chart position?</li>",
  "<li>How have the audio characteristics of Top 10 songs changed over time?</li>",
  "<li>Can Top 10 chart success be predicted using Spotify audio features?</li>",
  "</ol>",
  "<h2>Key outputs</h2>",
  "<p><b>Table 1:</b> correlations saved as <code>docs/tables/table1featurecorrelations.csv</code></p>",
  "<p><b>Figure 1:</b> scatterplots (valence, tempo, acousticness)</p>",
  "<img src='figures/figure1_scatter_valence.png' alt='Scatter valence'>",
  "<img src='figures/figure1_scatter_tempo.png' alt='Scatter tempo'>",
  "<img src='figures/figure1_scatter_acousticness.png' alt='Scatter acousticness'>",
  "<p><b>Figure 2:</b> trends (danceability, energy, loudness) comparing Top 10 vs Not Top 10</p>",
  "<img src='figures/figure2_trend_danceability.png' alt='Trend danceability'>",
  "<img src='figures/figure2_trend_energy.png' alt='Trend energy'>",
  "<img src='figures/figure2_trend_loudness.png' alt='Trend loudness'>",
  "<p><b>Figure 3:</b> decision tree (Top 10 classification)</p>",
  "<img src='figures/figure3decisiontreetop10.png' alt='Decision tree'>",
  "<p>All code and instructions for running the analysis are available in the repository README.</p>",
  "</body></html>"
)

writeLines(indexhtml, con = file.path("docs", "index.html"))
